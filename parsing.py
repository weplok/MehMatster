...
def bachalor_applicant_count_free_places(direction):
    ...
    return f'Места на бюджете: {free_places[direction.lower()]}'
...
def bachalor_applicant_count_paid_places(direction):
    ...
    return f'Места на коммерции: {paid_places[direction.lower()]}'
...
def bachalor_applicant_pass_balls(direction):
    ...
    return f'Проходные баллы: {pass_balls[direction.lower()]}'
...
def master_applicant_pass_balls(direction):
    ...
    return f"экзамен:{pass_balls[direction.lower()]}"